...
public class TransactionUtil {
  ...
  protected static final int TRANSACTION_FEE_VALUE_SIZE = 8;
  protected static final int TRANSACTION_OUTPOINT_INDEX_SIZE = 4;
  protected static final int COINBASE_OUTPUT_VALUE_SIZE = 35;
  protected static final int TRANSACTION_OUTPUT_VALUE_SIZE = 2634;
